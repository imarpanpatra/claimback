...
export function describeFlight(f) {
  ...
  return {
    ...
    // The law measures delay at arrival at the gate, which is what these times record.
    arrivalDelayMin: arr.scheduled && arr.actual ? Math.round((arr.actual - arr.scheduled) / 60) : null,
